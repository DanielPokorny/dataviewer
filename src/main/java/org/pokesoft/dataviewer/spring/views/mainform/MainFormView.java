package org.pokesoft.dataviewer.spring.views.mainform;

import org.pokesoft.dataviewer.spring.backend.Employee;
...
import org.pokesoft.dataviewer.spring.MainView;

@Route(value = "mainform", layout = MainView.class)
@RouteAlias(value = "", layout = MainView.class)
@PageTitle("MainForm")
@CssImport("styles/views/mainform/main-form-view.css")
public class MainFormView extends Div {
